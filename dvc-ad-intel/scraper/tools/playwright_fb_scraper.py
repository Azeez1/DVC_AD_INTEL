...
async def scrape_facebook_ads(search_query: str):
    ...
    async with async_playwright() as p:
        ...
        # Scroll the page several times to trigger dynamic content loading.
        for _ in range(5):
            await page.evaluate("window.scrollTo(0, document.body.scrollHeight)")
            await asyncio.sleep(2)  # Pause to allow new content to load.

        # Select all ad containers. Using a generic container class "xh8yej3"
